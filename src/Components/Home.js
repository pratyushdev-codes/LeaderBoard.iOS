  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      for (let index = 0; index < teamNameList.length; index++) {
        ...
        await fetch(
          "https://api.counterapi.dev/v1/reound2_techastra/" + teamName
        )
          .catch((error) => {
            data[teamName] = 0;
          })
  ...
  return (
    <div style={componentStyle}>
      ...
      >
        ...
        <h1 style={{ fontWeight: "bold", marginBottom: "20px", zIndex: "2" }}>
          Welcome to iOS Club's XXX event
        </h1>
        <h4 style={{ fontWeight: "bold", color: "grey", marginBottom: "40px" }}>
