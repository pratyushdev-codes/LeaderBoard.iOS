...
function Registeration() { 
    ...
    function submitForm(formData) {
      fetch('https://script.google.com/macros/s/AKfycby-CTUVxwfsp_gVn-H8HGaFEigKp9TRvusxnYq852NKaB8s2FZZVxmW4u3PUmy4miFK/exec', {
        method: 'POST',
        body: formData,
      }).then(() => {
...
if (emailValue.trim().length < 2) {
  ...
  const fetchData = async () => {
        const url = 'https://ios-demo-server.onrender.com/ping';
...
<p class="card-text" style={bodyStyle}>Total Payable Amount: ₹2950/-</p>
<p class="card-text"style={{fontSize:"13px"}}>Registration Fees(₹2500) + GST(₹450)*</p>
